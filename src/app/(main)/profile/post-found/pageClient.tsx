      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Help someone find their lost item by posting details about what you found.
          </p>
        </div>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                Provide as much detail as possible to help identify the owner
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={() => (
            <FormItem>
              ...
              <FormDescription>
                Upload photos of the item (up to 5 images)
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
